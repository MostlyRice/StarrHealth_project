myApp.controller('GeneralController', ['$http', 'UserService', 'SignupService', '$location', 'SchoolService', function($http, UserService, $location, SignupService, SchoolService) {
