myApp.controller('GeneralController', ['$http', 'UserService', '$location', 'SignupService', 'SchoolService', function($http, UserService, $location, SignupService, SchoolService) {
